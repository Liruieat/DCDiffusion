"""
DCDiffusion Testing Script

This script performs inference/testing using trained diffusion models
for nuclear segmentation and classification.

Usage:
    python test.py --dataset consep --model_type base_256x512 \
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Test DCDiffusion models")
